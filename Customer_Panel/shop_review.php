...
<!-- Review section -->
  <?php
    ...
    function check_Buy_Product()
    {
      ...
      $user_name  = $_SESSION['user_name'];
      $db     = new Database();
      $sql    = "SELECT * FROM tb_order_product WHERE shop_id='".$_POST['shop_id']."' AND order_by='$user_name'";
      $result = $db->select($sql);
...
<head>
    ...
    <title>Binimoy.XYZ - Shop Review</title>
                        ...
                        <div class="row">
                          ...
                          <div class="col-9 m-auto">
                            ...
                            <form action="" method="post" enctype="multipart/form-data" autocomplete="off">
                                  ...
                                  <label>Comment *</label>
                                  <textarea class="form-control" name="comment" rows="2" placeholder="Please type your valuable comment..." required></textarea>
