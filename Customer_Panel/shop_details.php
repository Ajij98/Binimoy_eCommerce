                            ...
                            <div class="col-md-6">
                                <div class="product-details">
                                    ...
                                    <div class="product-details-action">
                                        ...
                                        <a href="shop_review.php?shop_id=<?php echo $shop_id; ?>" class="btn btn-outline-success ml-3 mb-2 mt-2" style="padding-top: 12px; padding-bottom: 12px;"><span><i class="fa fa-star-o" aria-hidden="true"></i>Add Shop Review</span></a>
            ...
            <nav class="mobile-nav">
                <ul class="mobile-menu">
                    <li class="megamenu-container active">
                                ...
                                <li>
                                    <a href="#available_product">Buy Medicine</a>
                                </li>
                                <li>
                                    <a href="dashboard.php">My Account</a>
                                </li>
