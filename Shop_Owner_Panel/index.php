<?php
 ...
 <?php
     ...
     $sql  = "SELECT * FROM tb_order_product WHERE shop_owner = '$user_name' AND order_date = '$current_date'";
 ...
 <?php
     ...
     $sql  = "SELECT * FROM tb_order_product WHERE shop_owner = '$user_name'";
...
<head>
  ...
  <title>Binimoy.XYZ | Dashboard</title>
...
<div class="wrapper">
    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a href="pages/order_payment_history.php" class="nav-link">
              <i class="nav-icon fas fa-history"></i>
              <p>
  ...
  <footer class="main-footer">
    <strong>Copyright &copy; <?php echo date("Y"); ?> <a href="index.html">Binimoy.XYZ</a>.</strong>
    All rights reserved.
