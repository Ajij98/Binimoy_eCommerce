<?php
 ...
 <?php
   ...
   if(isset($_GET['product_id']))
   {
     ...
     $sql     = "SELECT * FROM tb_product WHERE product_id = $product_id AND shop_id = $shop_id";
  ...
  <?php
   ...
   if(isset($_POST['update']))
   {
         ...
         if($product_image_1 != "")
         {
           ...
           $sql = "UPDATE tb_product SET name='$name',email='$email',phone='$phone',shop_id='$shop_id',shop_code='$shop_code',shop_name='$shop_name',shop_location_details='$shop_location_details',product_name='$product_name',product_type='$product_type',product_price='$product_price',product_image_1='$dst_db_1',product_description='$product_description',product_brand='$product_brand',fixed_price_or_not='$fixed_price_or_not',product_upload_date='$product_upload_date' WHERE product_id = $product_id";
         ...
         if($product_image_2 != "")
         {
           ...
           $sql = "UPDATE tb_product SET name='$name',email='$email',phone='$phone',shop_id='$shop_id',shop_code='$shop_code',shop_name='$shop_name',shop_location_details='$shop_location_details',product_name='$product_name',product_type='$product_type',product_price='$product_price',product_image_2='$dst_db_2',product_description='$product_description',product_brand='$product_brand',fixed_price_or_not='$fixed_price_or_not',product_upload_date='$product_upload_date' WHERE product_id = $product_id";

           $update_row = $db->update($sql);
         }


          $sql = "UPDATE tb_product SET name='$name',email='$email',phone='$phone',shop_id='$shop_id',shop_code='$shop_code',shop_name='$shop_name',shop_location_details='$shop_location_details',product_name='$product_name',product_type='$product_type',product_price='$product_price',product_description='$product_description',product_brand='$product_brand',fixed_price_or_not='$fixed_price_or_not',product_upload_date='$product_upload_date' WHERE product_id = $product_id";
...
<head>
  ...
  <title>Binimoy.XYZ | Update Product Details</title>
                  ...
                  <form action="" method="post" enctype="multipart/form-data" autocomplete="off">
                      ...
                      <div class="form-row">
                        <div class="form-group col-lg-6">
                          ...
                          <input type="text" class="form-control" id="product_name" name="product_name" placeholder="Enter product Name"  name="product_name" value="<?php echo $product_name; ?>" required>
                        </div>
                        <div class="form-group col-lg-6">
                          <label for="product_type">Product Category *</label>
                          <select class="form-control" name="product_type" required>
                            <option selected=""><?php echo $product_type; ?></option>
                      ...
                      <div class="form-row">
                        <div class="form-group col-lg-4">
                          ...
                          <input type="number" class="form-control" id="product_price" name="product_price" placeholder="Enter product Price" value="<?php echo $product_price; ?>" required>
                        </div>
                        <div class="form-group col-lg-4">
                          <img src="<?php echo $product_image_1; ?>" height="100" alt="product_img_1"><br>
                        ...
                        <div class="form-group col-lg-4">
                          <img src="<?php echo $product_image_2; ?>" height="100" alt="product_img_2"><br>
                      ...
                      <div class="form-group">
                          ...
                          <textarea rows="3" class="form-control" id="product_description" name="product_description" placeholder="Enter Product Description" required><?php echo $product_description; ?></textarea>
                      </div>

                      <div class="form-row">
                        <div class="form-group col-lg-4">
                          <label for="product_brand">Product Brand (If Any) </label>
                          <input type="text" class="form-control" id="product_brand" name="product_brand" placeholder="Enter Product Brand Name (If Any)" value="<?php echo $product_brand; ?>">
                        </div>
                        <div class="form-group col-lg-4">
                          <label for="fixed_price_or_not">Fixed Price *</label>
                            <select class="form-control" id="fixed_price_or_not" name="fixed_price_or_not" required>
                              <option selected><?php echo $fixed_price_or_not; ?></option>
                              <option>Yes</option>
                              <option>No</option>
                            </select>
                        </div>
                        <div class="form-group col-lg-4">
                            ...
                            <input type="date" class="form-control" id="product_upload_date" name="product_upload_date" value="<?php echo $product_upload_date; ?>" required>
                          </div>
                      </div>
