                ...
                <div class="card-body">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td>
                        <a href="add_product.php?shop_id=<?php echo $result['shop_id']; ?>" class="btn btn-success btn-rounded btn-sm"><i class="fa fa-plus fa-fw"></i> Add Product</a>
                      </td>
                      <td>
                        <a href="view_product_details.php?shop_id=<?php echo $result['shop_id']; ?>" class="btn btn-secondary btn-rounded btn-sm"><i class="fa fa-eye fa-fw"></i> View Product</a>
                      </td>
                    </tr>
                    <?php } ?>
                    <?php }else{ ?>
