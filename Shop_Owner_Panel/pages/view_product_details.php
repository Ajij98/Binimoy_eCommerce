...
<!-- Product table data load -->
 <?php
   ...
   if(isset($_GET['shop_id']))
   {
     ...
     $db           = new Database();
     $sql          = "SELECT * FROM tb_product WHERE shop_id = $shop_id AND shop_owner = '$user_name'";
...
<head>
  ...
  <title>Binimoy.XYZ | View Product Details</title>
              ...
              <!-- form start -->
                <div class="card-body">
                  ...
                  <tbody>
                    ...
                    <?php if($read_product){ $i = 0; ?>
                    <?php while($result = $read_product->fetch_assoc()){ $i = $i + 1; ?>
                    <tr>
                      <td><?php echo "Product Id-".$result['product_id']; ?></td>
                      <td><img src="<?php echo $result['product_image_1']; ?>" height="100" alt="product_img"></td>
                      <td><?php echo $result['product_name']; ?></td>
                      <td><?php echo $result['product_type']; ?></td>
                      <td><?php echo $result['product_code']; ?></td>
                      <td><?php echo "Tk. ".$result['product_price']; ?></td>
                      <td><?php echo $result['product_brand']; ?></td>
                      <td><?php echo $result['fixed_price_or_not']; ?></td>
                      ...
                      <td><?php echo $result['product_upload_date']; ?></td>
                      <td><?php echo $result['name']; ?></td>
                      <td><?php echo $result['email']; ?></td>
                      <td><?php echo $result['phone']; ?></td>
                      <td>
                        <a href="update_product_details.php?product_id=<?php echo $result['product_id']; ?>&shop_id=<?php echo $shop_id; ?>" title="update" class="btn btn-info btn-sm waves-effect waves-light"><i class="fa fa-pencil"></i></a> || <a href="delete_product.php?product_id=<?php echo $result['product_id']; ?>&shop_id=<?php echo $shop_id; ?>" title="delete" onclick="return confirm('Are you sure to delete?')" class="btn btn-danger btn-sm btn-round waves-effect waves-light"><i class="fa fa-trash"></i></a>
                      </td>
                    </tr>
                    <?php } ?>
                    <?php }else{ ?>
