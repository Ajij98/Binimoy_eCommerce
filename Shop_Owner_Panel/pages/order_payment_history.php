<?php
 ...
 <!-- Customer order payment table data load -->
 <?php
   $user_name = $_SESSION['user_name'];
   $db   = new Database();
   $sql  = "SELECT * FROM tb_order_payment WHERE shop_owner = '$user_name'";
...
<head>
  ...
  <title>Binimoy.XYZ | Customer Order</title>
    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a href="order_payment_history.php" class="nav-link active">
              <i class="nav-icon fas fa-history"></i>
              <p>
                ...
                <div class="card-body">
                  ...
                  <tr>
                    <tr>
                      ...
                      <th>Bkash/Nagad Account Number</th>
                      <th>TrxID</th>
                  ...
                  <tbody>
                    ...
                    <tr>
                      <td class="text-success" style="font-weight: bold;"><?php echo "Order Id-".$result['payment_id']; ?></td>
                      ...
                      <td><?php echo $result['product_price']." Tk."; ?></td>
                      ...
                      <td>
                        <img src="<?php echo "../../Customer_Panel/".$result['payment_ss']; ?>" height="100" alt="payment_screenshot_image">
                      </td>
                      ...
                      <td>
                        <a href="delete_data.php?payment_id=<?php echo $result['payment_id']; ?>" title="delete" onclick="return confirm('Are you sure to delete payment history?')" class="btn btn-danger btn-sm btn-round waves-effect waves-light"><i class="fa fa-trash"></i></a>
                      </td>
                    </tr>
                    <?php } ?>
                    <?php }else{ ?>
