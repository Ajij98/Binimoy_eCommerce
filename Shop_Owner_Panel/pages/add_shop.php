<?php
 ...
 <?php
   ...
   if(isset($_POST['submit']))
   {
         ...
         $sql = "INSERT INTO tb_shop(name,email,phone,shop_name,shop_type,about_shop,shop_location,shop_location_details,shop_image,shop_added_date,shop_oc_time,shop_contact,bkash_number,nagad_number,shop_code,shop_owner,entry_time)values('$name','$email','$phone','$shop_name','$shop_type','$about_shop','$shop_location','$shop_location_details','$dst_db','$shop_added_date','$shop_oc_time','$shop_contact','$bkash_number','$nagad_number','$shop_code','$shop_owner','$current_datetime')";
         ...
         if($insert_row)
         {
           ...
           <script type="text/javascript">
             window.alert("Shop added successfully. Thank You!");
...
<head>
  ...
  <title>Binimoy.XYZ | Add Shop</title>
                  ...
                  <form action="" method="post" enctype="multipart/form-data" autocomplete="off">
                                                            ...
                                                            <div class="form-group row">
                                                                ...
                                                                <div class="form-group row">
                                                                    ...
                                                                    <div class="col-sm-10">
                                                                        <select class="form-control" name="shop_location" required>
                                                                            <option selected>Select shop location</option>
                                                                ...
                                                                <div class="form-group row">
                                                                  ...
                                                                  <div class="col-sm-10">
                                                                    <textarea class="form-control" name="shop_location_details" rows="2" placeholder="Enter shop location details" required></textarea>
                                                                  </div>
                                                                </div>
